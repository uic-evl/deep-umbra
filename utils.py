...
def load(height_path, shadow_path, zoom, i, j):
...
def load_image_train(paths):
    ...
    input_image, real_image = load(height_path, shadow_path, zoom, i, j)
...
def get_train_test(height_path, shadow_path, city, date, zoom):
